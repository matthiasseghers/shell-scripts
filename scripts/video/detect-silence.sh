...
while [[ $# -gt 0 ]]; do
    case $1 in
        -t|--threshold) SILENCE_THRESHOLD="$2"; shift 2 ;;
        -d|--duration) SILENCE_DURATION="$2"; shift 2 ;;
        -f|--format) OUTPUT_FORMAT="$2"; shift 2 ;;
        -o|--output) OUTPUT_FILE="$2"; AUTO_OUTPUT=false; shift 2 ;;
        -F|--output-frames) OUTPUT_FRAMES=true; shift ;;
        -V|--output-video) OUTPUT_VIDEO=true; shift ;;
        -c|--from-csv) FROM_CSV="$2"; shift 2 ;;
        -h|--help) usage ;;
